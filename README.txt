...
# Date of Version 01: Jun. 30, 2026
#
# Author: Alexander Nickerson
#
...
#
# C03_Locations_(Owner/Type).py
# Purpose: Make maps showing all stations by owner or by type, on a static map.
# Files Used: Docs/List_Download_All.txt
...
# Files Used: Docs/List_Download_All.txt
# Files Made: Figs/Statistics/Counts_Depth_(FACT/USF).png
#
...
# Files Made: New pairs of those files
#
# IMPORTANT NOTE: This code MUST be fun after D01_QC_FACT, or issues will arise
#                 due to having two stations improperly QC'd.
#
# D03_Plot_QC_Year.py
# Purpose: Plot the provided water temperatures and their QC flags by year
# Files Used: Docs/List_Download_All.txt
#             Data/(FACT/NDBC/SWT)/QC_Years/[Reg]_YYYY.nc
# Functions : C01_Plot.py
# Files Made: Figs/Data/(FACT/NDBC/SWT)_L00N/[Reg].png
#
# IMPORTANT NOTE: This code produces many, many files, and will hog copious
#                 amounts of hard drive space if run for all stations.
#
# D03_Plot_QC.py
# Purpose: Plot the provided water temperatures and their QC flags
# Files Used: Docs/List_Download_All.txt
...
#
# E06_Climo_Stations.py
# Purpose: Make bar charts of the counts of stations in the SECOORA region and
#          five subregions that records sufficient data to compute annual means
#          in each year.
# Files Used: Docs/List_Climo_All.txt
#             Data/(FACT/NDBC/SWT/USF)/Climo/[Reg]_Year.nc)
# Files Made: Figs/Statistics/Data_Years_All.png
#             Figs/Statistics/Data_Years_(FACT/NDBC/SWT/USF).png
#
# E07_Climo_Statistics.py
# Purpose: Make a table of stations measuring data and having sufficient data
#          to compute annual means in any given year.
# Files Used: Docs/List_Climo_All.txt
# Files Made: Figs/Statistics/Data_Years_All.png
#             Stats/Climo_Years.txt
#
...
#
# G02_MHW_(All/Region).py
# Purpose: Make plots showing the temporal evolution of MHWs in the SECOORA
#          region and in each of the five subregions
# Files Used: Docs/List_Climo_All.txt
#             Data/(FACT/NDBC/SWT/USF)/Climo/[Reg]_Day.nc
# Files Made: Figs/Statistics/MHW_Events_(All/FACT/NDBC/SWT).png
