...
for i, stat in stat_all.iterrows():
    ...
    if stat["Reg"] == "41001": 
        P1 = np.logical_or(
                np.logical_and(df.index >= "2000-07-29T00:00:00",
                               df.index <  "2000-08-15T00:00:00"),
                np.logical_and(df.index >= "2016-04-28T00:00:00",
                               df.index <= "2016-05-05T00:00:00"))
        P2 = np.logical_and(df.index >= "2019-05-01T00:00:00",
                            df.index <  "2019-05-03T00:00:00")
    ...
    if stat["Reg"] == "41004": 
        P1 = np.logical_or(
                np.logical_and(df.index >= "1997-01-01T00:00:00",
                               df.index <  "1997-12-31T23:00:00"),
                np.logical_and(df.index >= "1999-10-01T00:00:00",
                               df.index <= "1999-11-16T00:00:00"))
        Pt = (P1 & ~np.isnan(df["wt_new"]))
    ...
    if stat["Reg"] == "41009": 
        P1 = np.logical_or(
                np.logical_and(df.index >= "2003-04-01T00:00:00",
                               df.index <  "2003-04-15T00:00:00"),
                np.logical_and(df.index >= "2005-02-01T00:00:00",
                               df.index <  "2005-02-17T01:00:00"))
        P2 = np.logical_and(df.index >= "2012-06-29T00:00:00",
                            df.index <  "2012-10-15T00:00:00")
        Pt = ((P1 | P2) & ~np.isnan(df["wt_new"]))
    ...
    if stat["Reg"] == "41010": 
        P1 = np.logical_or(
                np.logical_and(df.index >= "1994-10-01T00:00:00",
                               df.index <  "1994-10-07T00:00:00"),
                np.logical_and(df.index >= "2016-08-18T00:00:00",
                               df.index <  "2016-08-31T01:00:00"))
        Pt = (P1 & ~np.isnan(df["wt_new"]))
    ...
    if stat["Reg"] == "41036": 
        P1 = np.logical_or(
                np.logical_and(df.index >= "2010-01-01T00:00:00",
                               df.index <  "2010-12-01T00:00:00"),  
                np.logical_and(df.index >= "2015-01-01T00:00:00",
                               df.index <= "2015-02-01T00:00:00"))
        P2 = np.logical_and(df.index >= "2008-02-29T00:00:00",
                            df.index <  "2008-03-01T00:00:00")
        Pt = ((P1 | P2) & ~np.isnan(df["wt_new"]))
    ...
    # manual QC work
    if stat["Reg"] == "41064": 
        P1 = np.logical_and(df.index >= "2024-10-01T00:00:00",
                            df.index <  "2024-11-20T00:00:00")
        Pt = (P1 & ~np.isnan(df["wt_new"]))
    ...
    if stat["Reg"] == "42019": 
        P1 = np.logical_and(df.index >= "2011-01-01T00:00:00",
    ...
    if stat["Reg"] == "42020": 
        P1 = np.logical_and(df.index >= "2000-01-01T00:00:00",
                            df.index <  "2001-01-01T00:00:00") 
    ...
    if stat["Reg"] == "42039": 
        P1 = np.logical_or(
                np.logical_and(df.index >= "2012-09-01T00:00:00",
                               df.index <  "2012-11-01T00:00:00"),  
                np.logical_and(df.index >= "2005-03-01T00:00:00",
                               df.index <= "2005-07-01T00:00:00"))
        
        P2 = np.logical_or(
                np.logical_and(df.index >= "1999-07-16T00:00:00",
                               df.index <  "1999-07-25T00:00:00"),  
                np.logical_and(df.index >= "2000-11-01T00:00:00",
                               df.index <= "2000-11-15T00:00:00"))
    ...
    if stat["Reg"] == "42040": 
        P1 = np.logical_or(
                np.logical_and(df.index >= "2016-01-01T00:00:00",
                               df.index <  "2016-02-01T00:00:00"),  
                np.logical_and(df.index >= "2017-01-01T00:00:00",
                               df.index <= "2017-03-01T00:00:00"))
    ...
    if stat["Reg"] == "42099": 
        P1 = np.logical_and(df.index >= "2010-02-21T00:00:00",
                            df.index <  "2010-03-04T00:00:00") 
    ...
    if stat["Reg"] == "44056": 
        P1 = np.logical_or(
                np.logical_and(df.index >= "2014-05-05T00:00:00",
                               df.index <  "2014-05-31T00:00:00"),  
                np.logical_and(df.index >= "2019-06-01T00:00:00",
                               df.index <= "2019-08-26T00:00:00"))
    ...
    if stat["Reg"] == "42003": 
        P1 = np.logical_or(
                np.logical_and(df.index >= "2010-05-01T00:00:00",
                               df.index <  "2010-06-05T00:00:00"),  
                np.logical_and(df.index >= "2014-06-05T00:00:00",
    ...
    # manual QC work
    if stat["Reg"] == "42036": 
        P1 = np.logical_and(df.index >= "2006-09-01T00:00:00",
                            df.index <  "2006-09-14T00:00:00")
        Pt = (P1 & ~np.isnan(df["wt_new"]))
